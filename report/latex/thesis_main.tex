...
Consequently, we find that they fail to capture the complete geometric structure of the underlying empirical distributions, 
...
The core objective of the OT-ICA framework reduces to searching the Stiefel manifold for the rotation matrix that maximizes the non-Gaussianity of the projected data.
...
We find that this helps in circumvent the structural blind spots of standard surrogate measures.
